    ...
    return {
        visitor: {
            JSXElement(path) {
                ...
                */
                let attrValue = t.booleanLiteral(true);
                if (attrNode.value) {
                ...
                */
                if (t.isJSXElement(parent === null || parent === void 0 ? void 0 : parent.node) || t.isJSXFragment(parent === null || parent === void 0 ? void 0 : parent.node)) {
